...
## Singularity on SLURM cluster
  ...
  3. Start tmux session: `tmux new -s ibiem`
  4. Start IBIEM image in singularity: `srun singularity exec docker://ibiem/docker_rstudio_ibiem2020 port_and_password`
...
```
### Memory and CPUs
  - You might want to request more memory or more CPUs for your container. 
